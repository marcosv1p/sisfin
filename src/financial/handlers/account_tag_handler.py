...
class AccountTagHandler:
    def __init__(self, database: Union[DatabaseAdapterInterface, DatabaseHandler] = DatabaseHandler(database=Databases.ACCOUNTS_TAGS)):
        ...
        if not (isinstance(database, (DatabaseAdapterInterface, DatabaseHandler)) or 
            ...
            raise account_tag_handler_error.UnexpectedDatabaseTypeError(error_message="Tipo inesperado do argumento 'databese'")
    ...
    def database(self, value: Union[DatabaseAdapterInterface, DatabaseHandler]) -> None:
        ...
        if not (isinstance(value, (DatabaseAdapterInterface, DatabaseHandler)) or 
            ...
            raise account_tag_handler_error.UnexpectedDatabaseTypeError(error_message="Tipo inesperado do argumento 'value'")
    ...
    def _get_cache_by_id(self, id: UUID) -> Optional[AccountTagModel]:
        ...
        if not isinstance(id, UUID):
            raise account_tag_handler_error.UnexpectedArgumentTypeError(error_message="Tipo inesperado do argumento 'id'")
    ...
    def create_account_tag(self, account_tag: AccountTagModel) -> None:
        ...
        if not isinstance(account_tag, AccountTagModel):
            raise account_tag_handler_error.UnexpectedArgumentTypeError(error_message="Tipo inesperado do argumento 'account_tag'")
    ...
    def _change_attribute(self, id: UUID, name: str, value: Any) -> None:
        ...
        if not isinstance(name, str):
            raise account_tag_handler_error.UnexpectedArgumentTypeError(error_message="Tipo inesperado do argumento 'name'")
    ...
    def change_created_at(self, id: UUID, created_at: datetime) -> None:
        ...
        if not isinstance(created_at, datetime):
            raise account_tag_handler_error.UnexpectedArgumentTypeError(error_message="Tipo inesperado do argumento 'created_at'")
    ...
    def change_user_id(self, id: UUID, user_id: UUID) -> None:
        ...
        if not isinstance(user_id, UUID):
            raise account_tag_handler_error.UnexpectedArgumentTypeError(error_message="Tipo inesperado do argumento 'user_id'")
